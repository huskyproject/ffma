...
{$endif}
  ...
  function getArea(config:psfidoconfig; areaName:pchar):Psarea;
...
implementation
  ...
  function readConfig:Psfidoconfig; external 'fidoconfig';
  procedure disposeConfig(config:psfidoconfig); external 'fidoconfig';
  function getLink(config:sfidoconfig; addr:pchar):Pslink; external 'fidoconfig';
  function getLinkFromAddr(config:sfidoconfig; aka:saddr):Pslink; external 'fidoconfig';
  function getAddr(config:sfidoconfig; addr:pchar):Psaddr; external 'fidoconfig';
  function existAddr(config:sfidoconfig; aka:saddr):longint; external 'fidoconfig';
  function getArea(config:psfidoconfig; areaName:pchar):Psarea; external 'fidoconfig';
  function isLinkOfArea(link:pslink; area:psarea):longint; external 'fidoconfig';
  function dumpConfigToFile(config:psfidoconfig; fileName:pchar):longint; external 'fidoconfig';
(*
  function readLine(F:pFILE):Pchar; external 'fidoconfig';
  function parseLine(line:pchar; config:psfidoconfig):longint; external 'fidoconfig';
  procedure parseConfig(f:pFILE; config:psfidoconfig); external 'fidoconfig';
*)
  ...
  function isLinkOfFileArea(link:pslink; area:psfileareatype):longint; external 'fidoconfig';
  function getFileArea(config:psfidoconfig; areaName:pchar):Psfileareatype; external 'fidoconfig';
(*
  procedure dumpConfig(config:psfidoconfig; f:pFILE); external 'fidoconfig';
*)
